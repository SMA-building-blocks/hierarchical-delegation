...
help:
	...
	@echo ""
	@echo "If wanted it's possible to change the quantity of the worker agents by adding the variable QUORUM to the command, as seen in the next line"
	@echo "	$$ make build-and-run QUORUM=<Quantity of workers>"